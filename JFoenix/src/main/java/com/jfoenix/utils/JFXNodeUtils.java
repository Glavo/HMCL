...
public class JFXNodeUtils {
    ...
    private static final MethodHandle NEW_TREE_SHOWING_EXPRESSION;
    private static final MethodHandle DISPOSE_TREE_SHOWING_EXPRESSION;

    static {

        Class<?> cls = null;
        try {
            cls = Class.forName("com.sun.javafx.scene.TreeShowingProperty");
        } catch (ClassNotFoundException e) {
            try {
                cls = Class.forName("com.sun.javafx.scene.TreeShowingExpression");
        ...
        try {
            ...
            if (cls != null) {
                NEW_TREE_SHOWING_EXPRESSION = lookup
                        .findConstructor(cls, MethodType.methodType(void.class, Node.class))
                        .asType(MethodType.methodType(BooleanExpression.class, Node.class));

                DISPOSE_TREE_SHOWING_EXPRESSION = lookup
                        .findVirtual(cls, "dispose", MethodType.methodType(void.class))
                        .asType(MethodType.methodType(void.class, BooleanExpression.class));
            } else {
                NEW_TREE_SHOWING_EXPRESSION = lookup
                        .findStatic(NodeHelper.class, "treeShowingProperty", MethodType.methodType(BooleanExpression.class, Node.class));
                DISPOSE_TREE_SHOWING_EXPRESSION = null;
            }
        } catch (Exception e) {
    ...
    public static BooleanExpression treeShowingProperty(Node node) {
        try {
            return (BooleanExpression) NEW_TREE_SHOWING_EXPRESSION.invokeExact(node);
    ...
    public static void disposeTreeShowingProperty(BooleanExpression treeShowingProperty) {
        try {
            if (DISPOSE_TREE_SHOWING_EXPRESSION != null)
                DISPOSE_TREE_SHOWING_EXPRESSION.invokeExact(treeShowingProperty);
        } catch (RuntimeException | Error e) {
            throw e;
        } catch (Throwable e) {
            throw new RuntimeException(e);
