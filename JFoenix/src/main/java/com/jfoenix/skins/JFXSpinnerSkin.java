...
public class JFXSpinnerSkin extends SkinBase<JFXSpinner> {
    ...
    private final BooleanExpression treeShowingProperty;
    ...
    public JFXSpinnerSkin(JFXSpinner control) {
        ...
        treeShowingProperty = JFXNodeUtils.treeShowingProperty(control);
    ...
    public void dispose() {
        super.dispose();
        clearAnimation();
        JFXNodeUtils.disposeTreeShowingProperty(treeShowingProperty);
        arc = null;
        track = null;
        control = null;
    }
