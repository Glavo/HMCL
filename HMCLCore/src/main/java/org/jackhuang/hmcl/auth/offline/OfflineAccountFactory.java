...
public final class OfflineAccountFactory extends AccountFactory<OfflineAccount> {
    ...
    public OfflineAccount fromStorage(Map<Object, Object> storage) {
        ...
        OfflineSkin skin = OfflineSkin.fromStorage(tryCast(storage.get("skin"), Map.class).orElse(null));
    ...
    public static class AdditionalData {
        ...
        private final OfflineSkin skin;

        public AdditionalData(UUID uuid, OfflineSkin skin) {
            this.uuid = uuid;
            this.skin = skin;
        }
    }
