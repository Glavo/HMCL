...
@NotNullByDefault
public abstract class FetchTask2<T extends @UnknownNullability Object> extends Task<T> {
    ...
    public FetchTask2(List<DownloadCandidate> candidates) {
    ...
    private static final class HttpResumeContext {
        ...
        static @Nullable FetchTask2.HttpResumeContext of(UrlResponseInfo response) throws IOException {
